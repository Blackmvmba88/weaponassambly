...
# Caching a singleton result for valid build validation checks avoids redundant
# dataclass allocation and empty tuple creation on every successful validation pass (~1.4x speedup).
